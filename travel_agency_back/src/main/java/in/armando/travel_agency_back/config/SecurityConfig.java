...
public class SecurityConfig {
        ...
        // Filtro CORS global para garantizar compatibilidad incluso con OPTIONS
        @Bean
        public FilterRegistrationBean<CorsFilter> corsFilter() {
                ...
                config.setAllowedOrigins(List.of(
                                ...
                                "http://10.0.2.2:8080",
                                "https://web-okmnl2j6n-armandos-projects-bf6157fe.vercel.app"
                ));
                ...
                bean.setOrder(Ordered.HIGHEST_PRECEDENCE); // Se ejecuta antes de otros filtros
                return bean;
        }
